...
#### Task 2.3: Create a Delta Live Table pipeline to curate the data into progressively cleaner state in bronze->silver->gold layer. <a name="dlt-pipeline"></a>
...
<div class="warning" style='background-color:#FFF; color: #69337A; border-left: solid #FF4F00 4px; border-radius: 4px; padding:0.7em;'><span><p style='margin-top:1em; text-align:center'><b>Note: (TO BE SKIPPED)</b></p><p style='margin-left:1em;'>
 ...
 <ul><li> 01_campaign_analytics_DLT</li>
    <li>Campaign Powered by Twitter</li>
 <li>Retail Sales Data Prep Using Spark DLT </li></ul>
</p></span></div>
...
*If you click on **Start**, Databricks will start executing the pipeline which will take approximately 15 minutes.*
...
10. After approx 15 mins, this is the view you would have seen. **Observe** the data lineage of Bronze, Silver and variety of Gold tables.
