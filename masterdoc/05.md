...
3. On the **Azure Databricks** page, select **databricks<inject key="DeploymentId"></inject>**.
...
5. On the search bar of the Databricks web session type **Workspace (1)** and then select the **ML Solutions in OneBox (2)** notebook. 

    ![](../media/GL2-T1-S4.png)

6. Once the notebook is open, click on the **table of contents (1)** icon to expand the contents.
...
7. In the notebook, Scroll down to review the **cmd 11 (1)** cell and then review the output for **Exploratory Data Analysis**.

    ![](../media/GL2-T1-S6.png) 

8. Review the **cmd 29** cell.
...
9. Review the **cmd 44** cell to load Azure ML Workspace.
