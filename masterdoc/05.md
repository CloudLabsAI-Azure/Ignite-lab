...
*They can take up these cleaned-up data products and develop features for machine-learning models along with aggregated analytical datasets for data analysts*.
...
*Caching reduces scanning of the original files in future queries. It caches the contents of a table in Apache Spark cache. If a query is cached, a temporary view is created for the query.*
...
*In the audit history, you can view the history of the different table versions. You can load and display any of those versions.*
