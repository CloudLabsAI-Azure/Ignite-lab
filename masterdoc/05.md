...
8. To create a view that queries the first 100 campaigns, **select lines 35-44 (1)** in the script file and select **Run (2)** to create a view of the Campaign file in Serverless pool.
